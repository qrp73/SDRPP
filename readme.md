...
sudo apt update
sudo apt install -y \
   git wget p7zip-full build-essential cmake cmake-curses-gui libtool xxd autoconf libfmt-dev libssl-dev \
...
sudo pacman -Syu
sudo pacman -Sy \
    git wget base-devel cmake core/libtool core/autoconf fmt openssl \
