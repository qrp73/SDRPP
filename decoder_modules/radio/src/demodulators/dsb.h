...
namespace demod {
    ...
    public:
        ...
        void init(std::string name, ConfigManager* config, dsp::stream<dsp::complex_t>* input, double bandwidth, double audioSR) {
            ...
            // Define structure
            _demod.init(input, dsp::demod::SSB<dsp::stereo_t>::Mode::DSB, bandwidth, getIFSampleRate(), _agcEnabled, _agcAttack / getIFSampleRate(), _agcDecay / getIFSampleRate());
        ...
        void showMenu() {
            ...
            if (ImGui::Checkbox(("##_radio_dsb_agc_enable_" + _name).c_str(), &_agcEnabled)) {
            ...
            if (ImGui::SliderFloat(("##_radio_dsb_gain_" + _name).c_str(), &_agcGain, -10.0f, 90.0f, "%.0f dB")) {
                if (!_agcEnabled) {
                    _demod.setAGCGain(pow(10, _agcGain/20));
                    _config->acquire();
            ...
            ImGui::SetNextItemWidth(menuWidth - ImGui::GetCursorPosX());
            if (ImGui::SliderFloat(("##_radio_dsb_agc_attack_" + _name).c_str(), &_agcAttack, 1.0f, 200.0f)) {
            ...
            ImGui::SetNextItemWidth(menuWidth - ImGui::GetCursorPosX());
            if (ImGui::SliderFloat(("##_radio_dsb_agc_decay_" + _name).c_str(), &_agcDecay, 1.0f, 20.0f)) {
