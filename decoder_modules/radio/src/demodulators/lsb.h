...
namespace demod {
    ...
    public:
        ...
        void init(std::string name, ConfigManager* config, dsp::stream<dsp::complex_t>* input, double bandwidth, double audioSR) {
            ...
            // Define structure
            demod.init(input, dsp::demod::SSB<dsp::stereo_t>::Mode::LSB, bandwidth, getIFSampleRate(), _agcEnabled, _agcAttack / getIFSampleRate(), _agcDecay / getIFSampleRate());
        }
        ...
        void showMenu() {
            ...
            if (ImGui::Checkbox(("##_radio_lsb_agc_enable_" + name).c_str(), &_agcEnabled)) {
            ...
            if (ImGui::SliderFloat(("##_radio_lsb_agc_attack_" + name).c_str(), &_agcAttack, 1.0f, 200.0f)) {
            ...
            ImGui::SetNextItemWidth(menuWidth - ImGui::GetCursorPosX());
            if (ImGui::SliderFloat(("##_radio_lsb_agc_decay_" + name).c_str(), &_agcDecay, 1.0f, 20.0f)) {
